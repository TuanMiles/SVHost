  ...
  const handleDeleteProduct = async (id: string) => {
    try {
      ...
      if (response.message === 'success') {
        message.success('Phòng đã được chuyển vào thùng rác!')
      }
    } catch (error) {
    ...
    ...columnsStaff,
    {
      ...
      render: (_: any, product: IProduct) => {
        if (!deleteReal) {
          return (
            <Space>
              ...
              <Popconfirm
                ...
                description={`Phòng sẽ được ${product.is_active ? 'ẩn đi!' : 'hiển thị'}`}
          ...
          return (
            <Space>
              <Tooltip title='Khôi phục Phòng'>
                <Popconfirm
                  title='Bạn có muốn khôi phục Phòng này?'
