            ...
            <form onSubmit={handleSubmit(onLogin)} autoComplete='off'>
              ...
              <div className='mb-5'>
                <input
                  type='submit'
                  value='Đăng nhập'
                  className='border-primary bg-primary hover:bg-opacity-90 w-full p-4 text-white transition bg-[#e5383b] border rounded-lg cursor-pointer'
                />
              </div>
            </form>
          </div>
