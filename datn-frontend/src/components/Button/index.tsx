...
const Button = ({ children, type, size, shape, style, onClick, disabled }: Props) => {
  return (
    <button
      disabled={disabled}
      onClick={onClick}
      className={`bg-[#ef233c] mb-1 text-sm  uppercase ${disabled && 'bg-opacity-[0.5] pointer-events-none select-none'}
      ...
      ${type === 'keep-buying' && 'border border-[#d8b979] bg-[#ffffff] text-[#ef233c]'}
